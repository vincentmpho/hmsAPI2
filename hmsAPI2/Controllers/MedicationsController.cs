    ...
    public class MedicationsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var medication = await _context.Medication
                .FirstOrDefaultAsync(m => m.MedicationNumber == id);
            if (medication == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("MedicationNumber,Dosage,ActiveEngredients,Strengths,Schedule,ContraIndicationR")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MedicationNumber,Dosage,ActiveEngredients,Strengths,Schedule,ContraIndicationR")] Medication medication)
        {
